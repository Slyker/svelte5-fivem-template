<h1 align="center">Svelte 5 FiveM template</h1>

This repository is a basic boilerplate for getting started
with Svelte in NUI. It can be used for both in browser and
in game development. It is **highly** based on [this repo](https://github.com/project-error/svelte-lua-boilerplate/blob/main/README.md) now using Svelte 5.
